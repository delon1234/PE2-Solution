...
final class Account {
  ...
  public Pair<Account, Account> transferTo(Account toAccount, double amount) {
    return new Pair<>(this.withdraw(amount), toAccount.deposit(amount));
  }
  ...
  public Account close() {
    return new Account(this.getAccountNumber(), this.getBalance(), true, this.getOwners());
  }
